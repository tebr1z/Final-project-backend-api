...
namespace LmsApiApp.DataAccess.Migrations
{
    ...
    [Migration("20241002151256_AssigmentSubissionresBagFixed")]
    partial class AssigmentSubissionresBagFixed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseGroup", b =>
                {
                    b.HasOne("LmsApiApp.Core.Entities.Course", null)
                        .WithMany()
                        .HasForeignKey("CoursesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LmsApiApp.Core.Entities.Group", null)
                        .WithMany()
